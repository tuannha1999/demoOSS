...
<?php
	...
	//	$hinhanh=$_POST['hinhanh'];
		...
		$madm=$_POST['madm'];
		$insert="INSERT INTO sanpham ( tensp, hinhanh, mau, chitiet, soluong, daban, gia, khuyenmai1, khuyenmai2, madm, ngaycapnhat, trangthai)
		VALUES( '$ten_sanpham', '$file__name__', '$mau', '$chitiet', '$soluong','0', '$gia', '$khuyenmai1', '$khuyenmai2', '$madm', '$ngay','0')";
